...
class Preprocessor:
    """
        This class shall  be used to clean and transform the Training_Batch_Files before training.
    ...
    def encode_categorical_columns(self,data):
        ...
        try:
            ...
            self.cat_df['police_report_available'].replace(np.nan,'NO',inplace=True)
            ...
            self.data.to_csv("D:\insaurance_fraud_detection\Training_Data_to_csv\check_point.csv")
            return self.data
